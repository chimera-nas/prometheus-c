    ...
    char **argv)
{
    ...
    struct prometheus_gauge          *gauge1, *gauge2;
    struct prometheus_gauge_series   *series11, *series12, *series21, *series22;
    struct prometheus_gauge_instance *instance11, *instance12, *instance21, *instance22;
    char                              buffer[4096];
